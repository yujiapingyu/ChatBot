...
- feedback.correctedSentence: 
  * 针对用户原句给出更完整、更自然的表达建议
  * 评估标准：语法正确性 + 表达完整性 + 场景适配度 + 日本人常用表达
  * 即使语法正确，如果表达过于简略、不够自然或不适合当前场景，也必须提供改进版本
  * 例如："そそ" → "そうそう、それでどうなったの？" (补全为完整对话句)
- feedback.explanation: 
  * 严格使用日文说明修改原因（语法/礼貌度/自然度/场景匹配/表达完整性等），禁止对单词进行假名注音
  * 如果原句已经完整且恰当，简要说明"在XXX场景下表达恰当"
